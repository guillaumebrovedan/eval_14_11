...
$balise_titre="Solaire";
$balise_meta="Venir parcourir notre catalogue de matériel de production d'énergie solaire. Nous avons tout le necessaire, du panneau solaire jusqu'à l'onduleur. Aidez l'environnement en choisissez le photovoltaïque.";
        ...
        <main class="p-0">
            <section class="container-fluid p-0">
                <div class="card-deck row row-cols-1 col-10 row-cols-md-2 col-md-12 row-cols-xl-3 m-auto">
                    ...
                    $requete = $db->prepare("SELECT * FROM produit_eval WHERE id_categorie=1 ORDER BY prix ASC");
                    $requete->execute();
